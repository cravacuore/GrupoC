...
class BookDetailsPage extends HeadBlankPage {
	...
	var book: Book = new Book("no title","no isbn","no editorial","this must be an Image-URL","no description") 
 	...
 	override def onInitialize {
 	  	...
 	  	if (this.book == null) this.book = new Book("no title","no isbn","no editorial","this must be an Image-URL","no description")
